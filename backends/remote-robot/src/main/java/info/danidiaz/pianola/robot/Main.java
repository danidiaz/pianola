package info.danidiaz.pianola.robot;
...
public class Main implements Runnable
{
    ...
    private final static int DEFAULT_PORT = 26066;
    ...
    public static void main(String argv[]) {
        ...
        System.out.println( "Hi, I'm the remote robot.");
        ...
        try {
            ...
            Thread serverThread = new Thread(new Main(serverSocket,messagePack));
            serverThread.setDaemon(true);
            serverThread.start();
            System.out.println("Remote robot started at port " + port);
    ...
    public Main(ServerSocket serverSocket, MessagePack messagePack) {
        super();
